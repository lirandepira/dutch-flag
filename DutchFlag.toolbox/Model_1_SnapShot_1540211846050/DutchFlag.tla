...
variables t \in [1..N->0..2];           (* Array of N integers in 0..MAXINT *)
          ...
          high \in low..N;                                 (* This is the smallest blue *)
          mid = 1;
          temp = 0;
          l = 1;
          r = N;
...
Lbl_2 == /\ pc = "Lbl_2"
         /\ IF mid <= high
               ...
               ELSE /\ Assert(( \E i \in 1..N : \A j \in 1..N : j < i => t[j] <= low ), 
                              "Failure of assertion at line 42, column 11.")
                    /\ Assert(( \E i \in 1..N : \A j \in 1..N : j > i => t[j] >= high ), 
                              "Failure of assertion at line 43, column 11.")
                    /\ pc' = "Done"
...
\* Last modified Mon Oct 22 14:36:59 CEST 2018 by lirandepira
